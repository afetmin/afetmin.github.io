...
![原型](/assets/img/posts/原型与原型链/image1.png)
...
![原型](/assets/img/posts/原型与原型链/image2.png)
...
![原型](/assets/img/posts/原型与原型链/image3.png)

原型也是一个对象，那就可以通过 Object 构造函数生成，所以

![原型](/assets/img/posts/原型与原型链/image4.png)

Object.prototype.**proto** 的值为 null 跟 Object.prototype 没有原型，其实表达了一个意思。

### 一些细节

![原型](/assets/img/posts/原型与原型链/image5.png)
...
![原型](/assets/img/posts/原型与原型链/image6.png)
