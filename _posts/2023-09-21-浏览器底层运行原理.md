...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822201830-rf2mxww.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822201842-3eq7iel.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822202530-p84h1dv.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822202540-7bf6us2.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822202639-01u8go0.png)V8 在执行过程中既有解释器 Ignition，又有编译器 TurboFan，此外较新版本的 Chrome 增加了一种中间层编译器 Maglev，V8 可以使用 jsvu 进行本地调试。
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822202924-2pwair0.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822202954-i6knpq4.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822203430-kfxwn9k.png)
...
![image](/assets/img/posts/浏览器底层运行原理/image-20230822203904-itlu98x.png)
